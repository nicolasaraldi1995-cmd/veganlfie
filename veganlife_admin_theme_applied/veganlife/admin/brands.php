<?php $active='brands'; $page_title='Brands'; require __DIR__."/_layout_top.php"; 
$items = $pdo->query("SELECT id, nombre FROM marcas ORDER BY nombre")->fetchAll();
?>
  <div class="table-container">
    <div class="table-title">Marcas</div>
    <table>
